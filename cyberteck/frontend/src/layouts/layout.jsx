    ...
    <div className="max-w-4xl px-8 mx-auto lg:px-16">
        ...
        <div className="relative mt-2 mt-12 space-y-5">
            ...
            <div  className="relative overflow-hidden border-2 border-gray-200 rounded-lg select-none hover:bg-white">
                ...
                <p className="pt-0 -mt-2 text-gray-400 sm:text-lg py-7 px-7" >Implementation in your project is very simple. You can use the exported page as a starting point, or you can copy and paste the HTML into your own page.</p>
            </div>
            ...
            <div  className="relative overflow-hidden border-2 border-gray-200 rounded-lg select-none hover:bg-white">
                ...
                <p className="pt-0 -mt-2 text-gray-400 sm:text-lg py-7 px-7" >You will have unlimited access to all your pre-built pages; however, if you want to be able to download and export your pages, you'll need a pro account. Paddle for processing payments.</p>
            </div>
             ...
             <div  className="relative overflow-hidden border-2 border-gray-200 rounded-lg select-none hover:bg-white">
                ...
                <p className="pt-0 -mt-2 text-gray-400 sm:text-lg py-7 px-7" >You have unlimited use to the templates used in Tails; however, you cannot re-use the templates to sell for others to use.</p>
            </div>
            ...
            <div  className="relative overflow-hidden border-2 border-gray-200 rounded-lg select-none hover:bg-white">
                ...
                <p className="pt-0 -mt-2 text-gray-400 sm:text-lg py-7 px-7" >If you need assistance implementing the templates into your project you can contact support or you can visit our question section.</p>
            </div>
